...
namespace DiscordBot.Core.Data
{
    class Embed
    {
        public static Discord.Embed New(SocketUser author, EmbedFieldBuilder field, Color color, string title = "", string description = "", string footer = "")
        {
        ...
        public static Discord.Embed New(SocketUser author, EmbedFieldBuilder[] fields, Color color, string title = "", string description = "", string footer = "")
        {
            EmbedBuilder embed = new EmbedBuilder();
