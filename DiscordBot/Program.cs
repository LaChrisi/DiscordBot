            ...
            try
            {
                ...
                switch (customId)
                {
                    case "notes":
                        ...
                        var channel = (IMessageChannel) Client.GetChannel(1242853004395282513);
                        var message = (IUserMessage) await channel.GetMessageAsync(1243887965722378279);

                        await message.ModifyAsync(msgProps =>
                            {
